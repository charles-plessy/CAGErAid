...
```{r save and export}
saveRDS(ce$OKItoOSA, file = './inst/extdata/example_CAGEexp/OKItoOSA_SL.rds')
saveRDS(ce$OSAtoOSA, file = './inst/extdata/example_CAGEexp/OSAtoOSA_SL.rds')
...
for (i in names(ce)) {
  ...
  cctrack[cctrack$itemRgb == "grey"]  |> score() |> decode() |> log10() |> hist(br =
                                                                                 100)
  rtracklayer::export.bed(cctrack, paste0('./inst/extdata/example_CAGEexp/clusters_sl_', i, '.bed'))
  }
```
