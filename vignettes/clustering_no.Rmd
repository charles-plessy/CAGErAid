...
![plot of chunk plot reverse cumulatives raw no](plot reverse cumulatives raw no-1.png)![plot of chunk plot reverse cumulatives raw no](plot reverse cumulatives raw no-2.png)
...
![plot of chunk plot normalized reverse cumulatives norm no](plot normalized reverse cumulatives norm no-1.png)![plot of chunk plot normalized reverse cumulatives norm no](plot normalized reverse cumulatives norm no-2.png)
